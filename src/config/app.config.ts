export const appConfig = {
 name: 'StillDue', tagline: 'Keep it in view.',
 version: '0.1.0', defaultTimezone: 'UTC',
 ...
 sources: { ccf: { name: 'CCF Deadlines', repository: 'ccfddl/ccf-deadlines', branch: 'main', field: 'computer-science' } },
} as const;
