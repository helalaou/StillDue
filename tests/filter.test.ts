...
it('keeps pinned items first and ongoing work after dated items', () => {
  const a = { ...newDeadline(), title: 'Ongoing' },
    b = { ...newDeadline(), title: 'Pinned', pinned: true },
    c = { ...newDeadline(), title: 'Dated', dueAt: '2050-01-01T00:00:00Z' };
